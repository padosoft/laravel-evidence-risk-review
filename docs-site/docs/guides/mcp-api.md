---
title: MCP Tools
description: Expose read-only evidence review tools to agent clients.
---
...
MCP tools let agent workflows ask for an evidence review without embedding package-specific PHP knowledge.
...
The package ships framework-agnostic definitions and optional adapter glue guarded by dependency checks.
