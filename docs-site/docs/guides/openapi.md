---
title: OpenAPI
description: Use the bundled OpenAPI description for clients and linting.
---
...
OpenAPI turns the default-OFF HTTP surface into a predictable integration contract.
...
The spec is served by the package when API routes are enabled and is linted with Redocly.
