---
title: Profiles
description: Tune risk checks and thresholds per domain.
---
...
Profiles encode policy: what checks run, what evidence rank is enough, and how conservative verdicts should be.
...
Built-ins: default, engineering, medical, legal, finance.
...
```php
'min_tier' => ['definitive' => 85, 'likely' => 65, 'tentative' => 30],
```
