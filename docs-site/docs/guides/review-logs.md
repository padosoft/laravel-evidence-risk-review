---
title: Review Logs
description: Persist append-only review evidence when enabled.
---
...
Logs provide forensic auditability for why an answer was accepted, softened, flagged, or removed.
...
Stores: null, array, and database; database rows are append-only.
