---
title: HTTP API
description: Expose review operations through default-OFF REST endpoints.
---
...
HTTP is useful for SPAs and external services, but public routes must never appear accidentally in a host app.
...
Enable api.enabled, choose a prefix, and attach host-owned auth middleware.
