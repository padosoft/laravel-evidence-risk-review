...
description: Classify source strength through built-in and custom tiers.
---
...
Tier labels convert messy source metadata into ordered ranks that risk checks can reason about deterministically.
...
Built-in tiers include guideline, peer-reviewed, official, preprint, news, blog, search hint, and unverified.
...
```php
'tiers' => ['case_law' => ['rank' => 90, 'label' => 'Case law']],
```
