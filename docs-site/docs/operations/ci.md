---
title: CI
description: Run package and docs validation consistently.
---
...
CI should use full Git history for docmd git metadata and should not trigger interactive search model selection.
...
Commit .docmd-search/config.json; use checkout fetch-depth: 0 if CI builds docs.
