---
title: Testing
description: Validate package and documentation changes locally.
---
...
Testing spans PHP package gates and docmd static-site gates. Documentation is not complete until the generated HTML exists.
...
Docs gates are npm run check and npm run build inside docs-site.
