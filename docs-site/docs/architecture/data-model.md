---
title: Data Model
description: Understand DTOs, log entries, and persistence shape.
---
...
The data model makes review results portable across PHP, HTTP, MCP, and audit logs.
...
Core DTOs include ReviewArtifact, ClaimRef, SourceRef, ReviewFinding, and ReviewResult.
...
```json
{ "artifact_id": "answer-1", "claims": [], "sources": [] }
```
