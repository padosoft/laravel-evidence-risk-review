...
description: Design domain policies as data.
---
...
Good profiles are conservative, explainable, and easy to override without changing core code.
...
Prefer explicit thresholds and keyword lists over hidden service logic.
...
```php
'red_flags' => ['dosage', 'self-medication without supervision'],
```
