---
title: Standalone Boundaries
description: Avoid host leakage in reusable package code.
---
...
Standalone boundaries keep this package usable outside any single product, tenant model, RAG system, or LLM provider.
...
Architecture tests reject known host symbols and dependencies.
