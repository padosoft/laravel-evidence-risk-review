...
description: REST endpoint reference.
---
...
HTTP reference gives clients the route catalog, request shape, and error envelope.
...
Routes exist only when api.enabled is true.
