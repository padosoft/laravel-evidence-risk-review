---
title: PHP Reference
description: Public PHP methods and DTO entry points.
---
...
Reference pages optimize for exact names and copyable snippets rather than conceptual narrative.
...
Facade methods mirror core service behavior and return serializable DTOs or arrays.
...
```php
EvidenceRiskReview::review($artifact, $options);
EvidenceRiskReview::reviewArray($payload);
EvidenceRiskReview::labelTier($source);
```
