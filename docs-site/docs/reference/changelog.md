---
title: Changelog
description: Track public documentation and package changes.
---
...
Changelog entries make user-facing behavior easier to audit across releases.
...
This docs site starts as the public documentation surface for the package.
...
```text
Unreleased: docmd documentation site added.
```
