...
- Agent instructions: `AGENTS.md`, `CLAUDE.md`, `skills/laravel-evidence-risk-review-plan/SKILL.md`, `.claude/skills/copilot-pr-review-loop/SKILL.md`, `.github/copilot-instructions.md`, and `.github/PULL_REQUEST_TEMPLATE.md`.
...
- Do not substitute Codex review for Copilot review unless explicitly requested.
